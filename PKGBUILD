...
pkgver=1.0.0
pkgrel=1
pkgdesc="TLauncher for Minecraft with system tray support"
arch=('x86_64')
...
source=("tlrunner.py" "tlrunner.desktop" "tlrunner.install" "requirements.txt")  # Kaynak dosyalar
# md5sums=('SKIP' 'SKIP' 'SKIP' 'SKIP' 'SKIP')  # Kaldırıldı
